...
- Project memory: local files in `~/.openclaw/project-notes/` (`INDEX.md` is the map). Read at session start; record milestones/decisions there. Migrated off Mem 2026-07-01 (cutover complete; Mem tooling retired).
